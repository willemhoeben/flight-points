...
const en = {
  ...
  resultsTable: {
    ...
    noNonstopResults: "No nonstop options for this search.",
    filterAll: "All",
    noFilteredResults: "No results match these filters.",
    maxFeesUnder: "Under {amount}",
    allianceLabel: "Alliance",
    maxFeesLabel: "Max fees",
    stop: "stop",
    stops: "stops",
    seatsLeft: "left",
...
const nl: Dictionary = {
  ...
  resultsTable: {
    ...
    booking: "Boeken",
    nonstop: "Nonstop",
    nonstopOnly: "Alleen nonstop",
    filterLabel: "Resultaten filteren",
    noNonstopResults: "Geen nonstopopties voor deze zoekopdracht.",
    filterAll: "Alle",
    noFilteredResults: "Geen resultaten voor deze filters.",
    maxFeesUnder: "Onder {amount}",
    allianceLabel: "Alliantie",
    maxFeesLabel: "Max. kosten",
    stop: "tussenstop",
    stops: "tussenstops",
    seatsLeft: "over",
...
const de: Dictionary = {
  ...
  resultsTable: {
    ...
    filterLabel: "Ergebnisse filtern",
    noNonstopResults: "Keine Nonstop-Optionen für diese Suche.",
    filterAll: "Alle",
    noFilteredResults: "Keine Ergebnisse für diese Filter.",
    maxFeesUnder: "Unter {amount}",
    allianceLabel: "Allianz",
    maxFeesLabel: "Max. Gebühren",
    stop: "Zwischenstopp",
...
const fr: Dictionary = {
  ...
  resultsTable: {
    ...
    booking: "Réservation",
    nonstop: "Sans escale",
    nonstopOnly: "Sans escale uniquement",
    filterLabel: "Filtrer les résultats",
    noNonstopResults: "Aucune option sans escale pour cette recherche.",
    filterAll: "Tout",
    noFilteredResults: "Aucun résultat ne correspond à ces filtres.",
    maxFeesUnder: "Moins de {amount}",
    allianceLabel: "Alliance",
    maxFeesLabel: "Frais max.",
    stop: "escale",
    stops: "escales",
    seatsLeft: "restants",
...
const es: Dictionary = {
  ...
  resultsTable: {
    ...
    booking: "Reserva",
    nonstop: "Directo",
    nonstopOnly: "Solo directos",
    filterLabel: "Filtrar resultados",
    noNonstopResults: "No hay opciones directas para esta búsqueda.",
    filterAll: "Todo",
    noFilteredResults: "No hay resultados para estos filtros.",
    maxFeesUnder: "Menos de {amount}",
    allianceLabel: "Alianza",
    maxFeesLabel: "Tasas máx.",
    stop: "escala",
    stops: "escalas",
...
const it: Dictionary = {
  ...
  resultsTable: {
    ...
    nonstop: "Diretto",
    nonstopOnly: "Solo diretti",
    filterLabel: "Filtra risultati",
    noNonstopResults: "Nessuna opzione diretta per questa ricerca.",
    filterAll: "Tutti",
    noFilteredResults: "Nessun risultato per questi filtri.",
    maxFeesUnder: "Sotto {amount}",
    allianceLabel: "Alleanza",
    maxFeesLabel: "Tasse max.",
    stop: "scalo",
    stops: "scali",
    seatsLeft: "rimasti",
...
const ja: Dictionary = {
  ...
  resultsTable: {
    ...
    nonstopOnly: "直行のみ",
    filterLabel: "結果を絞り込む",
    noNonstopResults: "この検索条件に直行便はありません。",
    filterAll: "すべて",
    noFilteredResults: "この絞り込み条件に一致する結果はありません。",
    maxFeesUnder: "{amount}未満",
